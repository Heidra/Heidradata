                    ...
                    $(document).ready(function() {
                        ...
                        $('#artnameinput').keyup(function(event) {
							...
							for (i=0; i<3; i++) {
								...
								buttontext = buttons[i].innerHTML;
								res2 = buttontext.toLowerCase();
								
								if (res2.includes(res) && res.length !== 0) {
    				...
    				<div id="productlist">
            			<?php
            			 ...
            			 <div class="checkout">
                			 ...
                			 <button class="btn4" type="submit" name='finalize' value="store" id="checkoutbtn"><a href="checkout.php">Go to the Checkout</a></button> 
            			 </div>
        			</div>
